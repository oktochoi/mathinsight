...
export const mkt = {
  ...
  /* Typography */
  eyebrow: 'text-xs font-bold uppercase tracking-widest text-sky-700',
  ...
  link: 'font-semibold text-sky-700 hover:underline underline-offset-2',
  ...
  /* Carefor buttons */
  btnGreen:
    'inline-flex items-center justify-center rounded-full px-5 py-3 text-sm font-bold text-white bg-gradient-to-b from-lime-500 to-green-600 shadow-md shadow-green-600/30 hover:-translate-y-px transition-transform',
  btnGreenSm:
    'inline-flex items-center justify-center rounded-full px-4 py-2 text-sm font-bold text-white bg-gradient-to-b from-lime-500 to-green-600 shadow-md shadow-green-600/25 hover:-translate-y-px transition-transform',
  btnOrange:
  ...
  btnAccent:
    'inline-flex items-center justify-center rounded-full px-5 py-3 text-sm font-bold text-white bg-gradient-to-b from-orange-400 to-orange-600 shadow-md shadow-orange-500/35 hover:-translate-y-px transition-transform',
  btnGhost: 'inline-flex items-center justify-center rounded-md px-3 py-2 text-sm font-medium text-slate-600 hover:bg-sky-50 hover:text-sky-700',

  /* Brand */
  logo: 'flex items-center gap-2.5 shrink-0',
  logoMark:
    'flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-br from-sky-500 to-blue-700 text-lg text-white shadow-md shadow-blue-600/25',
  logoText: 'text-xl font-extrabold tracking-tight text-slate-800',

  /* Badges */
  badgeAi: 'inline-flex rounded px-2 py-0.5 text-[11px] font-semibold bg-sky-50 text-sky-800',
  ...
  cardBlue: 'rounded-2xl bg-gradient-to-br from-blue-600 to-sky-500 text-white shadow-lg shadow-blue-600/20',

  /* Forms */
  input:
    'w-full rounded-xl border border-slate-200 bg-white px-3.5 py-3 text-sm text-slate-800 placeholder:text-slate-400 focus:border-sky-500 focus:outline-none focus:ring-2 focus:ring-sky-100',
  label: 'mb-1.5 block text-xs font-semibold text-slate-500',
  fieldLabel: 'text-sm font-semibold text-slate-600',
  fieldInput:
    'w-full rounded-lg border border-slate-200 bg-white px-3.5 py-2.5 text-sm text-slate-800 focus:border-sky-500 focus:outline-none focus:ring-2 focus:ring-sky-100',
  ...
  contactEmail: 'mt-3 block text-xl font-bold text-sky-800',
